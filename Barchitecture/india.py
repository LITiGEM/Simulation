...
def diff_eqs(y, t):
    ...
    k2 = (59.76)  # Rate of transcription per transcript (1/hr)
    k3 = (0.0009936)  # Rate of translation (1/hr)
    d1 = (24.66)  # Degradation of transcript (1/hr)
    d2 = (39.6)  # Degradation of protein (Half-life of E.coli) (1/hr)
...
if __name__ == "__main__":
    ...
    t = np.linspace(0, 20, time_steps)  # Set the time frame (start_time, stop_time, step) time frames are equally spaced within the two limits
