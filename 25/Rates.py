...
if __name__ == "__main__":
    ...
    t = np.linspace(0, 40, time_steps)  # Set the time frame (start_time, stop_time, step)
    ...
    for L in L_range:
        ...
        plt.legend(['EL222 bound to promoter', 'mRNA', 'Translated protein', 'Surface-expressed protein', ],
                   loc='top left', bbox_to_anchor=(1, 0.5))

        plt.legend(['2 W', '6 W', '12 W', '14 W'], loc='upper left')
        plt.title('Figure 1: Effect light intensity has on the rate of intimin expression on the cell surface',
                  **asfont)
